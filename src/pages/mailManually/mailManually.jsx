...
import InputInfo from './components/common/inputInfo/InputInfoForm';
import MailWrite from './components/common/mailWrite/MailWriteComponent';
        ...
        <MainContent>
          <FormContainer>
            <InputInfo
              ...
              fromRef={fromRef}
            />
            <MailWrite label="내용 입력" bodyRef={bodyRef} />
            <BottomContainer>
